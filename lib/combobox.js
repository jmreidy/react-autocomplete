...
var Combobox = React.createClass({
  ...
  getInitialState: function() {
    return {
      ...
      inputValue: this.findInputValue(this.props),
      isOpen: false,
      focusedIndex: null,
  ...
  componentWillMount: function() {
    this.setState({
      menu: this.makeMenu(this.props.children)
    });
  },

  componentWillReceiveProps: function(newProps) {
    var newMenu = this.makeMenu(newProps.children);
    var inputValue = this.findInputValue(newProps);
  ...
  */
  makeMenu: function(children, value) {
